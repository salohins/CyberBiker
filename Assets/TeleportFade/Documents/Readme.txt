...
1. Create a material with 'TeleportFade/Built in' or 'TeleportFade/Built in (Normal Map)' shader.
2. Set that material to meshes.
3. Change parameters.
4. Enjoy!

<<<< Universal Render Pipeline >>>>
1. Create a material with 'Shader Graphs/TeleportFadeURP' shader.
2. Set that material to meshes.
3. Change parameters.
4. Enjoy!
